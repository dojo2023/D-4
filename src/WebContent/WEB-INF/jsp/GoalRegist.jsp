	...
	<div class="wrapper">
		...
		<main class="main">
			...
			<!-- 年月を遷移するためのボタン -->
				...
				<!-- 長期目標 -->
				<label>長期目標</label>
				<input id="lgInput" type="text" name="lg"><br>
				<!-- 短期目標１ -->
				<label>短期目標１</label>
				<input id="sgInput1" type="text" name="sg1"><input type="date" id="sgStart" name="day_s_1"  placeholder="開始">
  															<input type="date" id="sgEnd" name="day_e_1"  placeholder="終了"><br>
				<!-- 短期目標１のToDoグループ -->
				...
				<!-- 短期目標２ -->
				<label>短期目標２</label>
				<input id="sgInput2" type="text" name="sg2"><br>
				<!-- 短期目標２のToDoグループ -->
				...
				<!-- 短期目標３ -->
				<label>短期目標３</label>
				<input id="sgInput3" type="text" name="sg3"><br>
				<!-- 短期目標３のToDoグループ -->
				...
				<!-- 短期目標４ -->
				<label>短期目標４</label>
				<input id="sgInput4" type="text" name="sg4"><br>
				<!-- 短期目標４のToDoグループ -->
				...
				<!-- 短期目標５ -->
				<label>短期目標５</label>
				<input id="sgInput5" type="text" name="sg5"><br>
				<!-- 短期目標５のToDoグループ -->
